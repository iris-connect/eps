...
func (x *Acknowledgment) Reset() {
	*x = Acknowledgment{}
	if protoimpl.UnsafeEnabled {
		mi := &file_protobuf_eps_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Acknowledgment) Descriptor() ([]byte, []int) {
	return file_protobuf_eps_proto_rawDescGZIP(), []int{3}
}
...
func (x *Acknowledgment) GetError() *Error {
	if x != nil {
		return x.Error
	}
	return nil
...
var file_protobuf_eps_proto_rawDesc = []byte{
	...
	,
	...
	0x69, 0x72, 0x69, 0x73, 0x2d, 0x67, 0x61, 0x74, 0x65, 0x77, 0x61, 0x79, 0x2f, 0x65, 0x70, 0x73,
...
var file_protobuf_eps_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_protobuf_eps_proto_goTypes = []interface{}{
	(*Request)(nil),        // 0: Request
	(*Error)(nil),          // 1: Error
	(*Response)(nil),       // 2: Response
	(*Acknowledgment)(nil), // 3: Acknowledgment
	(*_struct.Struct)(nil), // 4: google.protobuf.Struct
}
var file_protobuf_eps_proto_depIdxs = []int32{
	4, // 0: Request.params:type_name -> google.protobuf.Struct
	4, // 1: Error.data:type_name -> google.protobuf.Struct
	1, // 2: Response.error:type_name -> Error
	4, // 3: Response.result:type_name -> google.protobuf.Struct
	1, // 4: Acknowledgment.error:type_name -> Error
	0, // 5: EPS.Call:input_type -> Request
	2, // 6: EPS.Respond:input_type -> Response
	2, // 7: EPS.ServerCall:input_type -> Response
	3, // 8: EPS.ServerRespond:input_type -> Acknowledgment
	2, // 9: EPS.Call:output_type -> Response
	3, // 10: EPS.Respond:output_type -> Acknowledgment
	0, // 11: EPS.ServerCall:output_type -> Request
	2, // 12: EPS.ServerRespond:output_type -> Response
...
func file_protobuf_eps_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_protobuf_eps_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
